(function () {
  ...
  angular
    ...
    //    };
    //}])
    .controller('JaunumiController', JaunumiController);

      JaunumiController.$inject = ['$scope', '$state', '$sce', 'ArticlesService'];

    
  function JaunumiController($scope, $state, $sce, ArticlesService) {
    var vm = this;
      
        //$analytics.pageTrack('/raksti/jaunumi');
