(function () {
  ...
  angular
    .module('rockarticles')
    .controller('RockarticlesListController', RockarticlesListController);

  RockarticlesListController.$inject = ['RockarticlesService', '$sce', '$filter', '$scope', '$state', '$meta', 'Socialshare', 'EventsService'];

  function RockarticlesListController(RockarticlesService, $sce, $filter, $scope, $state, $meta, Socialshare, EventsService) {
    var vm = this;
    ...
    RockarticlesService.query().$promise.then(function (results) {
      ...
      //vm.rockarticles = $sce.trustAsHtml(vm.rockarticles);
  }
}());
