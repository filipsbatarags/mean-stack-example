(function () {
  ...
  angular
   ...
   //     };
   // }])
    .controller('IntervijasController', IntervijasController);

      IntervijasController.$inject = ['$scope', '$state', '$sce', 'ArticlesService', '$meta', 'Socialshare'];

    
  function IntervijasController($scope, $state, $sce, ArticlesService, $meta, Socialshare) {
    var vm = this;
