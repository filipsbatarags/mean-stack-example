(function () {
  ...
  angular
   ...
   //     };
   // }])
    .controller('AtrastsprieksnamaController', AtrastsprieksnamaController);

      AtrastsprieksnamaController.$inject = ['$scope', '$state', '$sce', 'ArticlesService', '$meta', 'Socialshare'];

    
  function AtrastsprieksnamaController($scope, $state, $sce, ArticlesService, $meta, Socialshare) {
    var vm = this;
